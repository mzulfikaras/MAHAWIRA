  ...
  <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
    <ul>	<!-- SLIDE  -->
      ...
      data-description="Science says that Women are generally happier">
        <!-- MAIN IMAGE -->
        <img src="{{asset('assets/images/background/bg3.jpg')}}" alt="" 
        ...
        <div class="tp-caption Newspaper-Button rev-btn " 
          ...
          <a href="{{route('user.contact')}}"><div class="tp-caption Newspaper-Button rev-btn" 
          ...
          data-paddingbottom="[12,12,12,12]"
          data-paddingleft="[30,35,35,15]"
          style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;">CONTACT US</div></a> 
      </li>
      ...
      data-easeout="default" 
      data-masterspeed="default" 
      data-thumb="{{ asset('assets/images/backgroud/bg3.jpg')}}" 
      data-rotate="0" 
      data-fstransition="fade" 
      data-fsmasterspeed="1500" 
      data-fsslotamount="7" 
...
<!-- Testimonials -->
<div class="section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(../assets/images/background/bg2.jpg);">
          <div class="container">
    <div class="row">
